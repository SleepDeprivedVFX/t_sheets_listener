...
#
# Created: Tue Jan 14 19:21:56 2020
...
class Ui_WhosWorking(object):
    def setupUi(self, WhosWorking):
        ...
        WhosWorking.resize(720, 520)
        WhosWorking.setMinimumSize(QtCore.QSize(720, 481))
...
"}")
        ...
        self.slave_list.setColumnCount(7)
    ...
    def retranslateUi(self, WhosWorking):
        ...
        self.slave_list.horizontalHeaderItem(4).setText(QtGui.QApplication.translate("WhosWorking", "Total", None, QtGui.QApplication.UnicodeUTF8))
        self.slave_list.horizontalHeaderItem(5).setText(QtGui.QApplication.translate("WhosWorking", "Lunch", None, QtGui.QApplication.UnicodeUTF8))
        self.slave_list.horizontalHeaderItem(6).setText(QtGui.QApplication.translate("WhosWorking", "Edit", None, QtGui.QApplication.UnicodeUTF8))
