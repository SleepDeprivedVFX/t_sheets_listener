...
# Form implementation generated from reading ui file 'C:\Users\adamb\OneDrive\Documents\Scripts\Python\Utilities\time_queue\ui\time_lord_scope.ui'
#
# Created: Wed Jan 15 10:46:16 2020
...
class Ui_WhosWorking(object):
    def setupUi(self, WhosWorking):
        ...
        WhosWorking.setMinimumSize(QtCore.QSize(820, 481))
...
"}")
        ...
        item = QtGui.QTableWidgetItem()
        self.slave_list.setHorizontalHeaderItem(6, item)
        item = QtGui.QTableWidgetItem()
        self.slave_list.setHorizontalHeaderItem(7, item)
    ...
    def retranslateUi(self, WhosWorking):
        ...
        self.slave_list.horizontalHeaderItem(2).setText(QtGui.QApplication.translate("WhosWorking", "Entity", None, QtGui.QApplication.UnicodeUTF8))
        self.slave_list.horizontalHeaderItem(3).setText(QtGui.QApplication.translate("WhosWorking", "Task", None, QtGui.QApplication.UnicodeUTF8))
        self.slave_list.horizontalHeaderItem(4).setText(QtGui.QApplication.translate("WhosWorking", "Time", None, QtGui.QApplication.UnicodeUTF8))
        self.slave_list.horizontalHeaderItem(5).setText(QtGui.QApplication.translate("WhosWorking", "Total", None, QtGui.QApplication.UnicodeUTF8))
        self.slave_list.horizontalHeaderItem(6).setText(QtGui.QApplication.translate("WhosWorking", "Lunch", None, QtGui.QApplication.UnicodeUTF8))
        self.slave_list.horizontalHeaderItem(7).setText(QtGui.QApplication.translate("WhosWorking", "Edit", None, QtGui.QApplication.UnicodeUTF8))
