...
#
# Created: Sat Oct 06 11:47:07 2018
...
"color: rgb(230, 230, 230);")
        ...
        self.tag_1_label = qtGUI.QLabel(switchwitch)
        self.tag_1_label.setObjectName("tag_1_label")
        self.verticalLayout_3.addWidget(self.tag_1_label)
        ...
        self.tag_2_label = qtGUI.QLabel(switchwitch)
        self.tag_2_label.setObjectName("tag_2_label")
        self.verticalLayout_2.addWidget(self.tag_2_label)
        ...
        self.tag_3_label = qtGUI.QLabel(switchwitch)
        self.tag_3_label.setObjectName("tag_3_label")
        self.verticalLayout.addWidget(self.tag_3_label)
    ...
    def retranslateUi(self, switchwitch):
        ...
        self.tag_1_label.setText(qtGUI.QApplication.translate("switchwitch", "Tag 1", None))
        ...
        self.tag_2_label.setText(qtGUI.QApplication.translate("switchwitch", "Tag 2", None))
        ...
        self.tag_3_label.setText(qtGUI.QApplication.translate("switchwitch", "Tag 3", None))
